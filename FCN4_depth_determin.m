function [Drop_sum, Slab_sum] = FCN4_depth_determin(Drop_sum, Slab_sum,...
...
for i1 = 1:peri_num
    ...
    for i2 = 1:4
        ...
        x_mid = downstand_tem(i1).C_gross(i2).x_mid;
        y_mid = downstand_tem(i1).C_gross(i2).y_mid;
        ...
        for i3 = 1:num_point
            ...
            if x_tem < x_drop_max && x_tem > x_drop_min ...
                    && y_tem < y_drop_max && y_tem > y_drop_min
                downstand_tem(i1).C_gross(i2).depth(i3) = Drop_thickness;
            else
                downstand_tem(i1).C_gross(i2).depth(i3) = S_thickness;
            end
        end

        ele_tem = [x_mid', y_mid', ...
            downstand_tem(i1).C_gross(i2).ele_size*ones(length(x_mid),1)...
            ,downstand_tem(i1).C_gross(i2).intersect' ...
            ,downstand_tem(i1).C_gross(i2).depth'];
