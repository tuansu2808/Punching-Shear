function Downstand_sum = FCN11_perimeter_determination_radius_wall...
    (d_effective, hcx, hcy, ...
    Hole, Perimeter_num, number_of_hole, jump_step)
...
for i1 = 1:Perimeter_num
    ...
    Downstand_sum(i1).L_gross(1).x(1) = hcx/2-1.5*d_effective-distance_to_edge/(3^0.5);
    ...
    Downstand_sum(i1).L_gross(1).x_mid = hcx/2-1.5*d_effective-distance_to_edge/(3^0.5)+ele_size/2:ele_size:hcx/2-ele_size/2;
    ...
    Downstand_sum(i1).L_gross(3).x(1) = hcx/2-1.5*d_effective-distance_to_edge/(3^0.5);
    ...
    Downstand_sum(i1).L_gross(3).x_mid = ...
        hcx/2-1.5*d_effective-distance_to_edge/(3^0.5)+...
        ele_size/2:ele_size:hcx/2-ele_size/2;
    ...
    Downstand_sum(i1).L_gross(4).x(1) = hcx/2-1.5*d_effective-distance_to_edge/(3^0.5);
    Downstand_sum(i1).L_gross(4).x(2) = hcx/2-1.5*d_effective-distance_to_edge/(3^0.5);
    Downstand_sum(i1).L_gross(4).y(1) = -hcy/2-distance_to_edge;
    Downstand_sum(i1).L_gross(4).y(2) = -hcy/2-distance_to_edge;

    Downstand_sum(i1).L_gross(4).y_mid = ...
        [-hcy/2-distance_to_edge,-hcy/2-distance_to_edge];

    num_ele = length(Downstand_sum(i1).L_gross(4).y_mid);
    Downstand_sum(i1).L_gross(4).x_mid = ...
        (hcx/2-1.5*d_effective-distance_to_edge/(3^0.5))*ones(1,num_ele);

    Downstand_sum(i1).L_gross(4).ele_size = 0;
    ...
    Downstand_sum(i1).C_gross(1).ang = 0; 
    Downstand_sum(i1).C_gross(1).x_mid = ...
        [(hcx/2-1.5*d_effective-distance_to_edge/(3^0.5)),...
        (hcx/2-1.5*d_effective-distance_to_edge/(3^0.5))];

    Downstand_sum(i1).C_gross(1).y_mid = ...
        [-hcy/2-distance_to_edge,-hcy/2-distance_to_edge];
    Downstand_sum(i1).C_gross(1).ele_size = 0;
    ...
    Downstand_sum(i1).C_gross(4).ang = 0; 
    Downstand_sum(i1).C_gross(4).x_mid = ...
        [(hcx/2-1.5*d_effective-distance_to_edge/(3^0.5)),...
        (hcx/2-1.5*d_effective-distance_to_edge/(3^0.5))];
    Downstand_sum(i1).C_gross(4).y_mid = ...
        [-hcy/2-distance_to_edge,-hcy/2-distance_to_edge];
    Downstand_sum(i1).C_gross(4).ele_size = 0;
    ...
    Downstand_sum(i1).L_gross_inner(1).x(1) = hcx/2-1.5*d_effective-distance_to_edge_2/(3^0.5);
    ...
    Downstand_sum(i1).L_gross_inner(1).x_mid = hcx/2-1.5*d_effective-distance_to_edge_2/(3^0.5)+ele_size/2:ele_size:hcx/2-ele_size/2;
    ...
    Downstand_sum(i1).L_gross_inner(3).x(1) = hcx/2-1.5*d_effective-distance_to_edge_2/(3^0.5);
    ...
    Downstand_sum(i1).L_gross_inner(3).x_mid = ...
        hcx/2-1.5*d_effective-distance_to_edge_2/(3^0.5)+...
        ele_size/2:ele_size:hcx/2-ele_size/2;
    ...
    Downstand_sum(i1).L_gross_inner(4).x(1) = hcx/2-1.5*d_effective-distance_to_edge_2/(3^0.5);
    Downstand_sum(i1).L_gross_inner(4).x(2) = hcx/2-1.5*d_effective-distance_to_edge_2/(3^0.5);
    Downstand_sum(i1).L_gross_inner(4).y(1) = -hcy/2-distance_to_edge_2;
    Downstand_sum(i1).L_gross_inner(4).y(2) = -hcy/2-distance_to_edge_2;

    Downstand_sum(i1).L_gross_inner(4).y_mid = ...
        [-hcy/2-distance_to_edge_2,-hcy/2-distance_to_edge_2];

    num_ele = length(Downstand_sum(i1).L_gross_inner(4).y_mid);
    Downstand_sum(i1).L_gross_inner(4).x_mid = ...
        (hcx/2-1.5*d_effective-distance_to_edge_2/(3^0.5))*ones(1,num_ele);

    Downstand_sum(i1).L_gross_inner(4).ele_size = 0;
    ...
    Downstand_sum(i1).C_gross_inner(1).ang = 0; 
    Downstand_sum(i1).C_gross_inner(1).x_mid = ...
        [(hcx/2-1.5*d_effective-distance_to_edge_2/(3^0.5)),...
        (hcx/2-1.5*d_effective-distance_to_edge_2/(3^0.5))];

    Downstand_sum(i1).C_gross_inner(1).y_mid = ...
        [-hcy/2-distance_to_edge_2,-hcy/2-distance_to_edge_2];
    Downstand_sum(i1).C_gross_inner(1).ele_size = 0;
    ...
    Downstand_sum(i1).C_gross_inner(4).ang = 0; 
    Downstand_sum(i1).C_gross_inner(4).x_mid = ...
        [(hcx/2-1.5*d_effective-distance_to_edge_2/(3^0.5)),...
        (hcx/2-1.5*d_effective-distance_to_edge_2/(3^0.5))];
    Downstand_sum(i1).C_gross_inner(4).y_mid = ...
        [-hcy/2-distance_to_edge_2,-hcy/2-distance_to_edge_2];
    Downstand_sum(i1).C_gross_inner(4).ele_size = 0;
