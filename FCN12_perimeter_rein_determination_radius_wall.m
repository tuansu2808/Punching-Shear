function Downstand_sum = FCN12_perimeter_rein_determination_radius_wall...
    (d_effective, hcx, hcy, ...
    Hole, Perimeter_num, number_of_hole)
...
for i1 = 1:Perimeter_num
    ...
    Downstand_sum(i1).L_gross(1).x_mid = hcx/2-1.5*d_effective-distance_to_edge/(3^0.5)+ele_size/2:ele_size:hcx/2+distance_to_edge-ele_size/2;
    ...
    Downstand_sum(i1).L_gross(3).x_mid = ...
        ...
        ele_size/2:ele_size:hcx/2+distance_to_edge-ele_size/2;
